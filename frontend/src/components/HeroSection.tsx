  ...
  return (
    ...
    >
      ...
      >
        <a
          href="/c2"
          className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground shadow-sm transition-transform hover:scale-[1.03]"
        >
          Launch C2 Console <ArrowRight className="size-4" />
        </a>
        <a
          href="#inputs"
        ...
        >
          <Play className="size-4" /> System Overview
        </a>
      </motion.div>
